...
from transformers import ElectraConfig, AdamW, get_linear_schedule_with_warmup
...
class Trainer(object):
    def __init__(self, args, train_dataset=None, dev_dataset=None, test_dataset=None):
        ...
        self.config = self.config_class.from_pretrained(args.model_name_or_path, finetuning_lang=args.lang)
    ...
    def save_model(self):
        ...
        save_path = os.path.join(self.args.model_dir,self.args.lang)
    ...
    def load_model(self):
        ...
        model_path = os.path.join(self.args.model_dir,self.args.lang)
